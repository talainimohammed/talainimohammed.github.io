      ...
      <header className="App-header">
        ...
        <table align="center">
          ...
          <tbody>
            <tr>
              <td>Moniteurbus</td>
              <td>Java/SpringBoot, Microservices, Angular, Postgresql</td>
            </tr>
            <tr>
              <td>Restop</td>
              <td>Js, PHP, MySql</td>
            ...
            <tr>
              <td>Management of mutual insurance files</td>
              <td>C#, Sqlite, Sharepoint</td>
            </tr>
            <tr>
              <td>Management of supplementary pension payments</td>
              <td>C#, Sqlite</td>
            </tr>
            <tr>
              <td>Restaurant</td>
